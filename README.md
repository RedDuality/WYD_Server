...
Control who can access your MongoDB database. It's recommended to restrict this to only trusted IP addresses.
...
To **remove** access for a previously allowed IP:

```bash
sudo ufw delete allow from <IP_ADDRESS> to any port 27017
```